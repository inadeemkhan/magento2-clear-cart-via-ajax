# Magento2 Clear Cart Via Ajax
Magento 2 extension To Clear cart using ajax | Nadeem Khan
...
* Copy the content of the repo to the <b>app/code/Nadeem/ClearCart/</b> folder
* Run command:
...
If you encounter any problems or bugs, please <a href="https://github.com/mageprince/magento2-clear-cart-via-ajax/issues">open an issue</a> on GitHub.
